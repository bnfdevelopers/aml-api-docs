...
|                          | risk\_data                        |                               | object  | -      | Información de resultado de cálculo de riesgo de lavado                                                                                                                                                                                                                          |
|                          |                                   | risk\_value                   | float   | -      | Valor del cálculo de riesgo                                                                                                                                                                                                                                                      |
|                          |                                   | risk\_level\_unique\_description | varchar | 25    | Descripción única del resultado de riesgo de lavado. Toma los valores de `low`, `medium` y `high`                                                                                                                                                                              |
|                          |                                   | risk\_level\_description      | varchar | 25     | Descripción del resultado de riesgo de lavado, ejemplo `Riesgo Alto`                                                                                                                                                                                                             |
...
|                          | company\_code                     |                               | varchar | 6      | Código de la compañía a la que pertenece el cliente. Solo en casos donde la compañìa sea cliente de la entidad                                                                                                                                                                   |
...
|                          |                                   | reference\_relationship\_type\_description  | varchar | 50     | Toma los valors: familiar y unfamiliar                                                                                                                                                                                                                             |
|                          |                                   | reference\_relationship\_unique\_description  | varchar | 50     | Descripción única del Tipo de relación. Ejemplo: brother, father, mother, etc                                                                                                                                                                                    |
|                          |                                   | reference\_relationship\_description  | varchar | 50     | Descripción del Tipo de relación. Ejemplo: Hermano, Padre, Madre, etc                                                                                                                                                                                                    |
