...
|                          | cell\_phone\_country\_code*       |                               | varchar | 2      | Country code on Alpha-2 cell phone                                                                                                                                                                                                                                               |
|                          | cell\_phone\_country              |                               | varchar | 50     | Cell phone country                                                                                                                                                                                                                                                               |
|                          | other\_phones                     |                               | array   | -      | List of objects with additional phone information                                                                                                                                                                                                                                |
|                          |                                   | contact\_type\_unique\_description | varchar   | 45     | Unique description of the contact type. Example: cellphone                                                                                                                                                                                                                |
|                          |                                   | contact\_type                 | varchar | 45     | Description of the type of contact. Example: Cell phone                                                                                                                                                                                                                          |
|                          |                                   | description                   | varchar | 30     | Phone number                                                                                                                                                                                                                                                                     |
|                          |                                   | country\_code                 | varchar | 45     | Country code on Alpha-2 phone                                                                                                                                                                                                                                                    |
...
|                          | company\_code                     |                               | varchar | 6      | Code of the company to which the client belongs. Only in cases where the company is a client of the entity                                                                                                                                                                       |
